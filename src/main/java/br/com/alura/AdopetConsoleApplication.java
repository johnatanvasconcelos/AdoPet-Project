...
public class AdopetConsoleApplication {
    ...
    private static void cadastrarAbrigo() throws IOException, InterruptedException {
        ...
        HttpResponse<String> response = dispararReqisicaoPost(client, uri, json);
    ...
    private static HttpResponse<String> dispararReqisicaoPost(HttpClient client, String uri, JsonObject json) throws IOException, InterruptedException {
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(uri))
